...
<head>
  ...
  <link rel="stylesheet" href="{{asset('cms/dist/plugins/toastr/toastr.min.css')}}">
      ...
      <li class="breadcrumb-item">
        ...
        <div class="btn-group">
             ...
             <div class="dropdown-menu ">
              ...
              <button class=" dropdown-item " type="button"><a class="fas fa-user-edit " href="{{route('editUser',Auth::id())}}"> edit Information</a></button>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('AllCatogres')}}" class="nav-link ">
            ...
            <ol class="breadcrumb float-sm-right">
             ...
             <div class="btn-group">
                  <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    {{auth::user()->name}}                  </button>
                  <div class="dropdown-menu ">
                    <button class="dropdown-item" type="button"><a href="{{route('editUser',Auth::id())}}">edit Information</a></button>
